...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-secondary-dark py-8 text-text-gray text-center">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center space-x-6 mb-4">
          ...
          <a href="https://www.facebook.com/umoarsv" target="_blank">
          ...
          <a href="https://x.com/umoarsv" target="_blank">
          ...
          <a href="https://www.instagram.com/umoarsv/" target="_blank">
          ...
          <a href="https://www.youtube.com/@umoar6121" target="_blank">
        ...
        <p className="text-sm">
          &copy; {currentYear} Monseñor Oscar Arnulfo Romero. Todos los derechos reservados.
        </p>
      </div>
    </footer>
  );
